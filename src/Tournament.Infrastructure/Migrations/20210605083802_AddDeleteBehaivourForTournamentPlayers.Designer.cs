...
namespace Tournament.Infrastructure.Migrations
{
    ...
    [Migration("20210605083802_AddDeleteBehaivourForTournamentPlayers")]
    partial class AddDeleteBehaivourForTournamentPlayers
    {
            ...
            modelBuilder.Entity("Tournament.Core.Entities.TournamentPlayer", b =>
                {
                    b.HasOne("Tournament.Core.Entities.User", "Player")
                        .WithOne("Tournament")
                        .HasForeignKey("Tournament.Core.Entities.TournamentPlayer", "PlayerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
